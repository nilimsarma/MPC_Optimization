...
#define VECTOR_SIZE_b2	NUM_INEQUALITY_CONSTRAINTS

#define SQ_MATRIX_A_SIZE (HESSIAN_LAGRANGIAN_SIZE + DIAG_MATRIX_SIGMA_SIZE + JACOBIAN_INEQUALITIES_NUM_ROWS)
#define VECTOR_x_SIZE	 (VECTOR_SIZE_Px + VECTOR_SIZE_Pw + VECTOR_SIZE_Py)
#define VECTOR_b_SIZE	 (VECTOR_SIZE_b0 + VECTOR_SIZE_b1 + VECTOR_SIZE_b2)
